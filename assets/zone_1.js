...
export class zone_1 extends Phaser.Scene {
    ...
    // collectible  
        ...
        this.herbe1 = this.herbe.create(400, 2800, "herbe").setScale(0.05);
        this.herbe2 = this.herbe.create(450,2800, "herbe").setScale(0.05);
        ...
        this.fleur1 = this.fleur.create(150,2800, "fleur").setScale(0.07);
        this.fleur2 = this.fleur.create(200,2800, "fleur").setScale(0.07);
        this.fleur3 = this.fleur.create(250,2800, "fleur").setScale(0.07);
        this.physics.add.overlap(this.player, this.fleur, this.collectFleur, null, this);

        //baie
        this.baie = this.physics.add.group();

        this.baie1 = this.baie.create(300,2800, "baie").setScale(0.07);
        this.baie2 = this.baie.create(350,2800, "baie").setScale(0.07);
        ...
        this.eau1 = this.eau.create(350,2800, "eau").setScale(0.07);
        ...
        this.potion = this.add.image(825, 300, "potion").setScale(0.3 );
        this.potion.setScrollFactor(0);
        this.potion.setVisible(false);

        this.potionMelanger = this.add.image(825, 300, "potionMelanger").setScale(0.3) ;
        this.potionMelanger.setScrollFactor(0);
        this.potionMelanger.setVisible(true);
    ...
    update() {
        ...
        if (this.menuOpen === false){
            ...
            this.boutonPotion.setVisible(false);
            this.potion.setVisible(false);
            this.potionMelanger.setVisible(false);
        }
        else {
        ...
        if (this.score1 == 1 && this.score2 == 1 && this.score3 == 1 )
        {
            this.potionMelanger = true 
        }
        if (this.potionMelanger === true)
        {
        This.potionMelanger.setVisible(true)
        }
    ...
    collectFleur(player, baie){
        ...
        baie.disableBody(true, true); 
        this.score4 += 1  ; 
        this.scoreText4.setText(this.score4);
        }
